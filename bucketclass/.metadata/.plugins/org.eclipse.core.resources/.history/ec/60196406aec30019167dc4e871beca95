                    ...
                    <div class="container">
                        ...
                        <div class="right-side">
                            <div class="header-widget">
                                <a href="login.html" class="sign-in">로그인</a>
                                <a href="register.html" class="sign-in">회원가입</a>
                            </div>
                        </div>
                        <!-- Right Side Content / End -->
                    </div>
                        ...
                        <div class="tabs-container alt">
                            ...
                            <div class="tab-content" id="tab1" style="display: none;">
                                <form method="post" class="login">
                                    ...
                                    <div class="form-row">
                                        <input type="submit" class="button border margin-top-5" onclick=loginFunction(); name="login" value="로그인"/>

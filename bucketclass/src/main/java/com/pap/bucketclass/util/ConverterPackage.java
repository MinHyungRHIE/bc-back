...
public class ConverterPackage {
	...
	/*
	 * JSON array Type을 String 형태로 바꾸어준다.
	 */
	public static String convertJsonArrayToString(List<String> jsonArray) {
		ObjectMapper objectMapper = new ObjectMapper();
		String jsonInString = null;
		try {
			jsonInString = objectMapper.writeValueAsString(jsonArray);
		}catch(Exception e) {
			e.printStackTrace();
		}
		return jsonInString;        

			...
			<div id="header">
				<div class="container">
					...
					<sec:authorize access="isAnonymous()">
						<div class="right-side">
							<div class="header-widget">
								<a href="/login" class="sign-in">로그인</a><a href="/signup"
									class="sign-in">회원가입</a>
							</div>
						</div>
					</sec:authorize>
					...
					<sec:authorize access="hasRole('ROLE_PROVIDER')">
						<div class="right-side">
							<div class="header-widget">
								<a href="/logout" class="sign-in">로그아웃</a><a href="/signup"
									class="sign-in">회원가입</a>
								<div id="myPageButton" class="sign-in">마이페이지</div>
								<div id="myPageButton" class="sign-in">환영합니다</div>
							</div>
						</div>
					</sec:authorize>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="main-search-input">
								...
								<button class="button" onclick="">검색</button>
